function  lsm_align_single_ms

% modified from lsm_align_and_norm_ms, to run within a batch script that
% doesn't call individual Image folders, but a full flyID.
